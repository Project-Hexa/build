...
""" % bcb_dev)
  ...
  build_id = target_info.GetBuildProp("ro.hexa.display.version")
  build_day = target_info.GetBuildProp("ro.hexa.build.date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("ro.product.device")
  android_version = target_info.GetBuildProp("ro.hexa.ota.version_code")

  script.Print("--------------------------------------");
  script.Print("     _    _                           ");              
  script.Print("    | |  | |                          ");
  script.Print("    | |__| |   ___  __  __   __ _     ");
  script.Print("    |  __  |  / _ \ \ \/ /  / _` |    ");
  script.Print("    | |  | | |  __/  >  <  | (_| |    ");
  script.Print("    |_|  |_|  \___| /_/\_\  \__,_|    ");
  script.Print("                                      ");             
  script.Print("--------------------------------------");
